...
> - For [`utah_teapot_6k`](https://graphics.cs.utah.edu/teapot/), with $`3,493`$ vertices, the possibility of collision is ~$`0.57`$%.
> - For [`utah_teapot_33k`](https://graphics.cs.utah.edu/teapot/), with $`17,456`$ vertices, the possibility of collision is ~$`14.19`$%.
> - For [`bunny_144k`](https://casual-effects.com/data/), with $`72,378`$ vertices, the possibility over collision is **nearly certain**. This is true for every larger model as well.
